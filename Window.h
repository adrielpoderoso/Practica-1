...
public:
	...
	GLfloat gettrasladohelicoptero() { return trasladohelicoptero; }
	GLfloat getluzcofre() { return luzcofre; }
	bool getretrocediendo() { return retrocediendo; }
	bool getluzModeloEncendida() { return luzModeloEncendida; }
...
private:
	...
	GLfloat cajuela;
	GLfloat capotaje;
	GLfloat trasladohelicoptero;
	GLfloat luzcofre;
	bool retrocediendo; 
	bool luzModeloEncendida;  
